...
export class VerificationLogSchema extends BaseModel {
  static $columns = ['bizRegDocUrl', 'checkedById', 'craftsmanId', 'guaranteeDocUrl', 'id', 'idCardVerified', 'levelGranted', 'notes', 'pastCustomer1Called', 'pastCustomer2Called', 'verbalConsentAudited', 'verifiedAt'] as const
