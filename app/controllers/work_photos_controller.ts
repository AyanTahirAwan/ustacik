...
export default class WorkPhotosController {
  /**
   * List the authenticated craftsman's work photos.
   */
  ...
  /**
   * Add a work photo to the authenticated craftsman's portfolio.
   */
  ...
  /**
   * Delete one of the authenticated craftsman's work photos.
   */
