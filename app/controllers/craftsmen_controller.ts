...
export default class CraftsmenController {
  /**
   * Browse and filter public craftsman profiles.
   */
  ...
  /**
   * Show the authenticated craftsman's own profile.
   */
  ...
  /**
   * Update the authenticated craftsman's own profile.
   */
  ...
  /**
   * Show the public information of a craftsman.
   */
